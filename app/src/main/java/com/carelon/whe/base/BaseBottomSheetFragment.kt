 ...
 */
abstract class BaseBottomSheetFragment<out T: ViewDataBinding> : BottomSheetDialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setStyle(DialogFragment.STYLE_NO_FRAME, R.style.Theme_WholeHealthExperience_BottomSheet)
